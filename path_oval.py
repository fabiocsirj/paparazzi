class Path_oval:
    def __init__(self):
        ...
        self._center   = None
        self.raio      = 200
        self.rota      = [1, 0, 1, 0] # 0 = reto, 1 = horario, 2 = anti-horario
        self.show      = 1
    ...
    def setWP(self, center):
        ...
        self.waypoints.append(PVector(center.x+self.raio, center.y-self.raio)) # 2 = Dir. Sup.
        self.waypoints.append(PVector(center.x+self.raio, center.y+self.raio)) # 3 = Dir. Inf.
    ...
    def paint(self):
        if self.show:
            ...
            ellipse(self._center.x+self.raio, self._center.y, self.raio*2, self.raio*2)
            noStroke()
            rect(self.waypoints[2].x-self.raio, self.waypoints[2].y, self.raio, self.raio*2+1)
